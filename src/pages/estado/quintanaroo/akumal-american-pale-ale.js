                    ...
                    <div className="row align-items-center">
                        ...
                        <div className="col-12 col-md-9">
                            ...
                            <p className="pt-sans-bold" style={{textAlign: "justify"}}>
                                Cerveza de origen Americano tipo ale, maltas pilsner y vienna; lúpulos americanos cítricos y frutales.
                                Leve aroma a malta con notas herbales y frutales, con final seco y agradable al paladar, sin astringencia.
                            </p>
                        </div>
                    </div>
                </div>
