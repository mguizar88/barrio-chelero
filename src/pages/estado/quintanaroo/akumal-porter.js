                ...
                <div className="container">
                    <div className="row align-items-center">
                        ...
                        <div className="col-12 col-md-9">
                            <h1 style={{fontSize: "5rem"}} className="main-title text-center">Porter</h1>
                            <p className="pt-sans-bold" style={{textAlign: "justify"}}>
                                Cerveza de origen inglés tipo ale, color marrón oscuro con destellos de color rubí, lúpulos europeos terroso-herbal, malta pilsner, caramelo y tostadas aportan aromas y sabores a caramelo, chocolate y café.
                            </p>
                        </div>
                    </div>
                </div>
