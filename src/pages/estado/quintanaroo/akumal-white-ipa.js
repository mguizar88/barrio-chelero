                ...
                <div className="container">
                    <div className="row align-items-center">
                        ...
                        <div className="col-12 col-md-9">
                            <h1 style={{fontSize: "5rem"}} className="main-title text-center">White Ipa</h1>
                            <p className="pt-sans-bold" style={{textAlign: "justify"}}>
                                Cerveza de origen americano tipo ale, maltas pilsner, trigo malteado, trigo sin maltear y avena en hojuelas; lúpulos americanos frutales-cítricos en adición tardía y dry hopping.
                            </p>
                        </div>
                    </div>
                </div>
