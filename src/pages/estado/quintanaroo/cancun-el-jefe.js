                ...
                <div className="container">
                    <div className="row align-items-center">
                        ...
                        <div className="col-12 col-md-9">
                            <h1 style={{fontSize: "5rem"}} className="main-title text-center">El Jefe</h1>
                            <p className="pt-sans-bold" style={{textAlign: "justify"}}>
                                Cerveza Heffeweizen Americana. Color dorado; de cuerpo balanceado por la malta de trigo utilizada, enriquecida con cáscaras de naranja.
                                Es ideal para maridar con comidas livianas, ensaladas, productos del mar, sushi y salchichas blancas.
