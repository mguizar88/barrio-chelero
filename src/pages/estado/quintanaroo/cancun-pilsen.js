                ...
                <div className="container">
                    <div className="row align-items-center">
                        ...
                        <div className="col-12 col-md-9">
                            <h1 style={{fontSize: "5rem"}} className="main-title text-center">Pilsen</h1>
                            <p className="pt-sans-bold" style={{textAlign: "justify"}}>
                                Cerveza Pilsen color dorado. De cuerpo ligero, con un refrescante sabor proveniente de la malta utilizada, suavemente balanceada con toques de miel y un ligero lúpulo especiado.
                                Ideal para maridar con comidas livianas, pollo, ensaladas, salmón o salchichas alemanas.
