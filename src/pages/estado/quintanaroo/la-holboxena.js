                ...
                <div className="container">
                    <div className="row align-items-center">
                        ...
                        <div className="col-12 col-md-9">
                            <h1 style={{fontSize: "5rem"}} className="main-title text-center">La Holboxeña</h1>
                            <p className="pt-sans-bold" style={{textAlign: "justify"}}>
                                Notas de sabor de dulce coco rostizado, cacao suave, con balance perfecto en el amargor con una  flor de lúpulo perfectamente equilibrada y 3 tipos maltas.
