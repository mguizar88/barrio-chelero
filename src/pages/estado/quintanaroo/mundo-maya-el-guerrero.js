                ...
                <div className="container">
                    <div className="row align-items-center">
                        ...
                        <div className="col-12 col-md-9">
                            <h1 style={{fontSize: "5rem"}} className="main-title text-center">El Guerrero</h1>
                            <p className="pt-sans-bold" style={{textAlign: "justify"}}>
                                Está entre una IPA de estilo estadounidense e inglés, con la adición de jugos de frutas locales que hacen que sea única en su clase y un acabado de lúpulo cítrico. 
                            </p>
                        </div>
                    </div>
                </div>
