                ...
                <div className="container">
                    <div className="row align-items-center">
                        ...
                        <div className="col-12 col-md-9">
                            <h1 style={{fontSize: "5rem"}} className="main-title text-center">El Jaguar</h1>
                            <p className="pt-sans-bold" style={{textAlign: "justify"}}>
                                Cerveza de avena muy cremosa con bajo contenido de alcohol hace que sea una cerveza abundante y potable para un clima frio.
                            </p>
                        </div>
                    </div>
                </div>
