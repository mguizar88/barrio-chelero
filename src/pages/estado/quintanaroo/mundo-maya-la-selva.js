                ...
                <div className="container">
                    <div className="row align-items-center">
                        ...
                        <div className="col-12 col-md-9">
                            <h1 style={{fontSize: "5rem"}} className="main-title text-center">La Selva</h1>
                            <p className="pt-sans-bold" style={{textAlign: "justify"}}>
                                Cerveza de trigo estilo americano. Infundida con  naranjas silvestres que crecen en la selva maya. Esto le da un sabor único y local que se disfruta en los días calurosos.
                            </p>
                        </div>
                    </div>
                </div>
