                ...
                <div className="container">
                    <div className="row align-items-center">
                        ...
                        <div className="col-12 col-md-9">
                            <h1 style={{fontSize: "5rem"}} className="main-title text-center">La Serpiente</h1>
                            <p className="pt-sans-bold" style={{textAlign: "justify"}}>
                                La complejidad de la malta está a la vanguardia, con un amargor de lúpulo suficiente y un agradable acabado seco y un color ámbar claro y cristalino.
                            </p>
                        </div>
                    </div>
                </div>
