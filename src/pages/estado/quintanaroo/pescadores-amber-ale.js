                ...
                <div className="container">
                    <div className="row align-items-center">
                        ...
                        <div className="col-12 col-md-9">
                            <h1 style={{fontSize: "5rem"}} className="main-title text-center">Amber Ale</h1>
                            <p className="pt-sans-bold" style={{textAlign: "justify"}}>
                                Cerveza de origen Americano color cobrizo. Con sabor profundo, dulce y maltoso, con cambio de notas que termina con una persistencia de lúpulo.
                                Es la mejor amiga de un buen corte de carne, ahumados y quesos fuertes.
                            </p>
                        </div>
                    </div>
                </div>
