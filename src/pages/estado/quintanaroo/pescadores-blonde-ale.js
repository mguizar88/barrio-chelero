                ...
                <div className="container">
                    <div className="row align-items-center">
                        ...
                        <div className="col-12 col-md-9">
                            <h1 style={{fontSize: "5rem"}} className="main-title text-center">Blonde Ale</h1>
                            <p className="pt-sans-bold" style={{textAlign: "justify"}}>
                                Cerveza con balance entre una malta suave y pinceladas de lúpulo para todo momento. Ligera, clásica y de calidad. 
                                Esta cerveza va bien con pollo, ensaladas, mariscos y queso bajos en grasas o ahumados.
                            </p>
                        </div>
                    </div>
                </div>
