                ...
                <div className="container">
                    <div className="row align-items-center">
                        ...
                        <div className="col-12 col-md-9">
                            <h1 style={{fontSize: "5rem"}} className="main-title text-center">Habanero Ale</h1>
                            <p className="pt-sans-bold" style={{textAlign: "justify"}}>
                                Cerveza de color ambar ligera y con cuerpo. Pinceladas de lúpulo y con un sabor al chile más usado en la Península (habanero), exquisita.
                            </p>
                        </div>
                    </div>
                </div>
