                ...
                <div className="container">
                    <div className="row align-items-center">
                        ...
                        <div className="col-12 col-md-9">
                            <h1 style={{fontSize: "5rem"}} className="main-title text-center">Ambar Mestiza</h1>
                            <p className="pt-sans-bold" style={{textAlign: "justify"}}>
                                Cerveza estilo viena, combina la frescura típica de la levadura “lager”, con la complejidad de las maltas oscuras características de las cervezas “ale”. 
                                Sus maltas le dan un color ámbar que nos evoca el mestizaje de la tierra yucateca.
