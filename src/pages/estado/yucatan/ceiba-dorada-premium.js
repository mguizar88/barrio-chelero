                ...
                <div className="container">
                    <div className="row align-items-center">
                        ...
                        <div className="col-12 col-md-9">
                            <h1 style={{fontSize: "5rem"}} className="main-title text-center">Dorada-premium</h1>
                            <p className="pt-sans-bold" style={{textAlign: "justify"}}>
                                Cerveza Pilsner muy refrescante, clara, bien balanceada y con una efervescencia que nos recuerda al Champagne.
                            </p>
                        </div>
                    </div>
                </div>
