                ...
                <div className="container">
                    <div className="row align-items-center">
                        ...
                        <div className="col-12 col-md-9">
                            <h1 style={{fontSize: "5rem"}} className="main-title text-center">Imperial Stout</h1>
                            <p className="pt-sans-bold" style={{textAlign: "justify"}}>
                                Cerveza oscura, de sabor tostado y profundo, con espuma compacta y cuerpo sorprendentemente ligero, deliciosa y de perfecto balance.
