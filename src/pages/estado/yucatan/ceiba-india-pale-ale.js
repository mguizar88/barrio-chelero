                ...
                <div className="container">
                    <div className="row align-items-center">
                        ...
                        <div className="col-12 col-md-9">
                            <h1 style={{fontSize: "5rem"}} className="main-title text-center">India Pale Ale</h1>
                            <p className="pt-sans-bold" style={{textAlign: "justify"}}>
                                Cerveza en la que predominan los aromas frutales y el sabor a lúpulo que perdura. 
                                Es el producto de una extraordinaria combinación de cuatro especies de flor de lúpulo y nuestras maltas especiales.
