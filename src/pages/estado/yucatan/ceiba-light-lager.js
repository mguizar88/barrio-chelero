                ...
                <div className="container">
                    <div className="row align-items-center">
                        ...
                        <div className="col-12 col-md-9">
                            <h1 style={{fontSize: "5rem"}} className="main-title text-center">Light Lager</h1>
                            <p className="pt-sans-bold" style={{textAlign: "justify"}}>
                                Cerveza con sólo 34 kcal/100 ml. De ligero y fresco sabor, conserva las características naturales y artesanales que nos distinguen.
