                ...
                <div className="container">
                    <div className="row align-items-center">
                        ...
                        <div className="col-12 col-md-9">
                            <h1 style={{fontSize: "5rem"}} className="main-title text-center">Apa American Pale Ale</h1>
                            <p className="pt-sans-bold" style={{textAlign: "justify"}}>
                                Cerveza con aroma fuerte a lúpulo, caracter cítrico y limpio sabor a malta y caramelo.
                                Ideal para maridar con pollo y hamburguesas.
