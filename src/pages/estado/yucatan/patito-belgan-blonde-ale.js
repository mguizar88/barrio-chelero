                ...
                <div className="container">
                    <div className="row align-items-center">
                        ...
                        <div className="col-12 col-md-9">
                            <h1 style={{fontSize: "5rem"}} className="main-title text-center">Belgan Blonde Ale</h1>
                            <p className="pt-sans-bold" style={{textAlign: "justify"}}>
                                Aroma dulce especiado, con un toque frutal a plátano y clavo.
                                Ideal para maridar con pizzas, pastas, cortes y comida condimentada.
                            </p>
                        </div>
                    </div>
                </div>
