                ...
                <div className="container">
                    <div className="row align-items-center">
                        ...
                        <div className="col-12 col-md-9">
                            <h1 style={{fontSize: "5rem"}} className="main-title text-center">Dry Stout</h1>
                            <p className="pt-sans-bold" style={{textAlign: "justify"}}>
                                Cerveza con sabor amargo, sin sabor ni aroma a lúpulo, con notas de café.
                                Ideal para maridar con postres de frutos secos, café o chocolate. Mariscos crudos.
