                    ...
                    <div className="row align-items-center">
                        ...
                        <div className="col-12 col-md-9">
                            ...
                            <p className="pt-sans-bold" style={{textAlign: "justify"}}>
                                Cerveza estilo American Ipa, con aroma frutal tropical como durazno, mango y piña por sus finos lúpulos americanos: cascade y chinook.
                                Ideal para maridar con comida de tonos muy fuertes y picantes.
