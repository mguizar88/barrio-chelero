                ...
                <div className="container">
                    <div className="row align-items-center">
                        ...
                        <div className="col-12 col-md-9">
                            <h1 style={{fontSize: "5rem"}} className="main-title text-center">Lager Yucateca</h1>
                            <p className="pt-sans-bold" style={{textAlign: "justify"}}>
                                Cerveza estilo lager, con sabor y aromas ligero, balanceado entre maltas y lúpulos alemanes. Retrogusto regrescante.
                                Ideal para maridar con comida yucateca, mariscos y salsas de chile habanero.
