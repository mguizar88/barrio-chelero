                ...
                <div className="container">
                    <div className="row align-items-center">
                        ...
                        <div className="col-12 col-md-9">
                            <h1 style={{fontSize: "5rem"}} className="main-title text-center">Pilsner</h1>
                            <p className="pt-sans-bold" style={{textAlign: "justify"}}>
                                Cerveza estilo pilsner alemán. Aroma dulce maltoso con un toque a lúpulos nobles alemanes.
                                Ideal para maridar con ensalada, comida picante y salmón.
