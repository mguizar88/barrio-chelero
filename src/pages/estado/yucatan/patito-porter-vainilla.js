                ...
                <div className="container">
                    <div className="row align-items-center">
                        ...
                        <div className="col-12 col-md-9">
                            <h1 style={{fontSize: "5rem"}} className="main-title text-center">Porter Vainilla</h1>
                            <p className="pt-sans-bold" style={{textAlign: "justify"}}>
                                Cerveza con notas a cacao que contrastán el sabor al lúpulo y la dulzura de la vainilla
                                Ideal para maridar con barbacoa, carnes asadas y pescado.
