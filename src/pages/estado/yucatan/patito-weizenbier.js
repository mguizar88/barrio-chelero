                ...
                <div className="container">
                    <div className="row align-items-center">
                        ...
                        <div className="col-12 col-md-9">
                            <h1 style={{fontSize: "5rem"}} className="main-title text-center">Weizenbier</h1>
                            <p className="pt-sans-bold" style={{textAlign: "justify"}}>
                                Cerveza ale, refrescante y de cuerpo ligero con notas a levadura. Olores y sabores a clavo y plátano.
                                Ideal para maridar con pescados, mariscos, frituras y ensaladas.
